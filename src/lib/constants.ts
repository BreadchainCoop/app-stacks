...
export const DELEGATED_SAVING_CIRCLES_CONTRACT_ADDRESS =
  clientEnv.NEXT_PUBLIC_DELEGATED_SAVING_CIRCLES_CONTRACT_ADDRESS
    ? (clientEnv.NEXT_PUBLIC_DELEGATED_SAVING_CIRCLES_CONTRACT_ADDRESS as Address)
    : undefined;
