...
const envSchema = z.object({
  ...
  // Optional until the yield-bearing variant (saving-circles#189/#190) is deployed.
  NEXT_PUBLIC_YIELD_SAVING_CIRCLES_CONTRACT_ADDRESS: z
    .string()
    .optional()
    .default(""),
...
const parsedSchema = envSchema.safeParse({
  ...
  NEXT_PUBLIC_YIELD_SAVING_CIRCLES_CONTRACT_ADDRESS:
    process.env.NEXT_PUBLIC_YIELD_SAVING_CIRCLES_CONTRACT_ADDRESS,
