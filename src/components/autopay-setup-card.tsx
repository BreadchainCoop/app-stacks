...
export default function AutopaySetupCard({
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-4 border-b border-paper-2 pb-4">
        <div className="space-y-2">
          <Heading3 className="text-2xl leading-[100%]">
            Circle autopay
          </Heading3>
          <Body>
            Optional autopay only covers your own BREAD contribution path for
            this circle. You can skip setup now and enable it later from this
            page.
          </Body>
        </div>
            ...
            {user.status === "CONNECTED" ? (
              <>
                <LocalLiftedButton
                  ...
                  disabled={autopay.delegatedEnabled || pendingAction !== null}
                >
                ...
                <LocalLiftedButton
                  ...
                  disabled={autopay.allowanceReady || pendingAction !== null}
                >
