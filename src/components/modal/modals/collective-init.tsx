...
import { CollectiveCreationInitModalState } from "../context";
...
const steps = [
  ...
  "Configuring the voting rules...",
  "Finalizing fund creation...",
];

const CollectiveInitModal = ({
  modalState,
}: {
  modalState: CollectiveCreationInitModalState;
}) => {
...
export default CollectiveInitModal;
