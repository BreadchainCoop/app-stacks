...
import { GoalCreationInitModalState } from "../context";
...
const steps = [
  "Validating goal parameters...",
  "Setting up smart contract...",
  "Initializing member registry...",
  "Locking in the deadline...",
  "Finalizing goal creation...",
];

const GoalInitModal = ({
  modalState,
}: {
  modalState: GoalCreationInitModalState;
}) => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setCurrentStep((prev) => {
        ...
        // We finalize the last check list when creating the goal succeeds
    ...
    <ModalContainer>
      ...
      <div className="text-center">
        <Heading3 className="text-2xl mb-3">
          Creating your goal savings
        </Heading3>
        <Body className="text-surface-grey-2 mb-6">
          Please wait while we set up your goal..
        </Body>
