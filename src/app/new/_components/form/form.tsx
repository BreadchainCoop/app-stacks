...
import { Label, LabelWithTooltip } from "@/components/label";
import LocalLiftedButton from "@/components/lifted-button";
import { Body, Heading2, Heading3, Logo } from "@breadcoop/ui";
			...
			<section className="bg-paper-0 p-6 flex flex-col gap-4 shadow-[0px_4px_12px_0px_#1B201A26]">
				<header>
					...
					<Body className="text-surface-grey">
						Fill in the details for your Stack. Currently Stacks
						allows a stacks to only.
					</Body>
				</header>
				<div className="flex flex-col gap-4 mb-4">
					<Field>
						...
						/>
						<ErrorMessage
							msg={form.formState.errors.name?.message}
						/>
					</Field>
					<Field>
						<div>
						...
						<ErrorMessage
							msg={form.formState.errors.members?.message}
						/>
					</Field>
					<Field>
						<div>
						...
						<ErrorMessage
							msg={form.formState.errors.depositAmount?.message}
						/>
					</Field>
					<Field>
						<div>
							<Label htmlFor="depositInterval">
								Deposit Interval
							</Label>
						</div>
						<div className="flex flex-col gap-2">
							<RadioButton
								id="weekly"
								checked={
									form.watch("depositInterval") === "weekly"
								}
							...
							<RadioButton
								id="monthly"
								checked={
									form.watch("depositInterval") === "monthly"
								}
