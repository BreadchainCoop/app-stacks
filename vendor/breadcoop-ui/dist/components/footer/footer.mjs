...
import { BlueskyIcon } from "./bluesky.mjs";
function SocialIcons({ className = "" }) {
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("a", { href: LINKS.bluesky, className: "block", children: /* @__PURE__ */ jsx(BlueskyIcon, { className: "w-6 h-6 text-surface-ink" }) }),
        ...
        /* @__PURE__ */ jsx("a", { href: LINKS.newsletter, className: "block", children: /* @__PURE__ */ jsx(ParagraphIcon, { className: "w-6 h-6 text-surface-ink" }) }),
